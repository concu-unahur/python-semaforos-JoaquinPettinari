...
Computadora('Konnichiwa').start()
Computadora('Hajimemashite, Watashi wa Joaquin desu').start()
Computadora('Genki desu ka?').start()
Computadora('Genki desu. Nihongo ga wakarimasu ka?').start()
Computadora('Hai, wakarimasu').start()
